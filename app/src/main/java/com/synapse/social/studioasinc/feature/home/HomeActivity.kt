...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val settingsRepository = com.synapse.social.studioasinc.shared.data.repository.SettingsRepositoryImplImpl.getInstance(this@HomeActivity)
    ...
    private fun applyThemeFromSettings() {
        val settingsRepository = com.synapse.social.studioasinc.shared.data.repository.SettingsRepositoryImplImpl.getInstance(this)
