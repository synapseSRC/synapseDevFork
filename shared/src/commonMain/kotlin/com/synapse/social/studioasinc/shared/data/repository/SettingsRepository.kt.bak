...
interface SettingsRepository {
    ...
    suspend fun setChatThemePreset(preset: com.synapse.social.studioasinc.shared.domain.model.ChatThemePreset)



    suspend fun setChatWallpaper(wallpaper: com.synapse.social.studioasinc.shared.domain.model.ChatWallpaper)
