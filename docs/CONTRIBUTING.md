...
3.  **Branch:** Create a feature branch.
    ...
    - Example: `feature/auth-login-screen`, `fix/crash-on-startup`
...
6.  **Pull Request:** Submit a PR to the `main` branch.
    ...
    - Description: Explain what you changed and why. Link the issue (e.g., `Closes #123`).
    - Screenshots: Attach screenshots/videos for UI changes.
