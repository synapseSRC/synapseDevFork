    ...
    fun toMediaItemList(value: String?): List<MediaItem>? {
        return value?.let {
            if (it.isBlank()) emptyList() else try {
                ...
                Log.e(TAG, "Failed to decode MediaItemList: $it", e)
                emptyList()
            }
        }
    }
    ...
    fun toPollOptionList(value: String?): List<PollOption>? {
        return value?.let {
            if (it.isBlank()) emptyList() else try {
                ...
                Log.e(TAG, "Failed to decode PollOptionList: $it", e)
                emptyList()
            }
        }
    }
    ...
    fun toPostMetadata(value: String?): PostMetadata? {
        return value?.let {
            if (it.isBlank()) null else try {
                ...
                Log.e(TAG, "Failed to decode PostMetadata: $it", e)
                null
            }
        }
    }
    ...
    fun toReactionMap(value: String?): Map<ReactionType, Int>? {
        return value?.let {
            if (it.isBlank()) emptyMap() else try {
                ...
                Log.e(TAG, "Failed to decode ReactionMap: $it", e)
                emptyMap()
            }
        }
    }
    ...
    fun toReactionType(value: String?): ReactionType? {
        return value?.let {
            try {
                ...
                Log.w(TAG, "Unknown ReactionType value in database: $it")
                null
            }
        }
    }
    ...
    fun toStringMap(value: String?): Map<String, String>? {
        return value?.let {
            if (it.isBlank()) emptyMap() else try {
                ...
                Log.e(TAG, "Failed to decode StringMap: $it", e)
                emptyMap()
            }
        }
    }
    ...
    fun toStringList(value: String?): List<String>? {
        return value?.let {
            if (it.isBlank()) emptyList() else try {
                ...
                Log.e(TAG, "Failed to decode StringList: $it", e)
                emptyList()
            }
        }
    }
