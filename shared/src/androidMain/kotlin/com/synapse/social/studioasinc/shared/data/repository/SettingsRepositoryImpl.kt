...
class SettingsRepositoryImpl private constructor(
    ...
    override suspend fun setPostViewStyle(style: com.synapse.social.studioasinc.shared.domain.model.PostViewStyle) {
    ...
    override val mediaUploadQuality: Flow<com.synapse.social.studioasinc.shared.domain.model.MediaUploadQuality> = settingsDataStore.mediaUploadQuality

    override suspend fun setMediaUploadQuality(quality: com.synapse.social.studioasinc.shared.domain.model.MediaUploadQuality) {
    ...
    override val autoDownloadRules: Flow<com.synapse.social.studioasinc.shared.domain.model.AutoDownloadRules> = settingsDataStore.autoDownloadRules

    override suspend fun setAutoDownloadRule(
        networkType: String,
        mediaTypes: Set<com.synapse.social.studioasinc.shared.domain.model.MediaType>
    ) {
