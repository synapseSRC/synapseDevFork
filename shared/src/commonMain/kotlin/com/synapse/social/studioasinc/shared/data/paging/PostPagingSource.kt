...
import com.synapse.social.studioasinc.shared.data.repository.PollRepository
...
class PostPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Post> {
        ...
        return try {
            Napier.d("Loading posts at position: $position, pageSize: $pageSize", tag = "PostPagingSource")
            ...
            Napier.d("Loaded ${response.size} posts", tag = "PostPagingSource")
            ...
            Napier.e("Error loading posts", e, tag = "PostPagingSource")
            LoadResult.Error(e)
        }
    }
